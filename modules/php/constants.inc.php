...
const ST_PLAYER_PLANET_PADRAIGIN3110 = 57;
const ST_PLAYER_PLANET_TIFNOD = 58;
const ST_PLAYER_PLANET_VIZCARRA = 59;
...
const ST_PLAYER_PLANET_ZALAX = 64;
...
const CULTURE_PLANETS = array(
    ...
    //CHECKED PLANET_JAC110912 => new PlanetInfo("JAC-110912", PLANET_TRACK_ECONOMY, 4, 5, "Acquire 2 culture, all other players acquire 1 culture."),
    ...
    //CHECKED PLANET_OMICRONFENZI => new PlanetInfo("OMICRON-FENZI", PLANET_TRACK_DIPLOMACY, 3, 3, "Convert any number of energy into culture."),
    ...
    //CHECKED PLANET_ZALAX => new PlanetInfo("ZALAX", PLANET_TRACK_DIPLOMACY, 2, 2, "Reroll any number of your inactive dice."),
);
const ENERGY_PLANETS = array(
    ...
    //CHECKED PLANET_CLJ0517 => new PlanetInfo("CLJ-0517", PLANET_TRACK_ECONOMY, 2, 2, "Steal 1 culture from another player (only once during your turn)."),
    ...
    //CHECKED PLANET_SHOUHUA => new PlanetInfo("SHOUHUA", PLANET_TRACK_DIPLOMACY, 5, 7, "Advance a ship +1."),
    ...
    //CHECKED PLANET_VIZCARRA => new PlanetInfo("VIZCARRA", PLANET_TRACK_DIPLOMACY, 1, 1, "Regress 1 enemy ship by -1 economy."), 
