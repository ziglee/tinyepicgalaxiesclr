...
const ST_PLAYER_UPGRADE_EMPIRE = 36;
const ST_PLAYER_DECIDE_FOLLOW = 37;
...
const CULTURE_PLANETS = array(
    PLANET_ANDELLOUXIAN6 => new PlanetInfo("ANDELLOUXIAN-6", PLANET_TRACK_ECONOMY, 4, 5, "Move 1 of your ships from a planet\'s orbit to your galaxy, then acquire energy and/or culture equal to that ship\'s orbit number."),
    PLANET_BISSCHOP => new PlanetInfo("BISSCHOP", PLANET_TRACK_ECONOMY, 1, 1, "On your turn after utilizing this colony, if you are followed then acquire 1 energy per follow."),
    PLANET_DREWKAIDEN => new PlanetInfo("DREWKAIDEN", PLANET_TRACK_ECONOMY, 1, 1, "Advance +1 diplomacy."),
    PLANET_GYORE => new PlanetInfo("GYORE", PLANET_TRACK_ECONOMY, 5, 7, "Set 1 inactive die to a face of your choice."),
    PLANET_HELIOS => new PlanetInfo("HELIOS", PLANET_TRACK_DIPLOMACY, 2, 2, "Place an un-occupied planet from the center row into the bottom of the planet deck draw a new planet."),
    PLANET_HOEFKER => new PlanetInfo("HOEFKER", PLANET_TRACK_ECONOMY, 2, 2, "Spend 1 energy to acquire 2 culture."),
    PLANET_JAC110912 => new PlanetInfo("JAC-110912", PLANET_TRACK_ECONOMY, 4, 5, "Acquire 2 culture, all other players acquire 2 culture."),
    PLANET_JAKKS => new PlanetInfo("JAKKS", PLANET_TRACK_DIPLOMACY, 1, 1, "Acquire 1 culture."),
    PLANET_JORG => new PlanetInfo("JORG", PLANET_TRACK_DIPLOMACY, 3, 3, "Spend 2 culture to regress 1 enemy ship by -2."),
    PLANET_KWIDOW => new PlanetInfo("K-WIDOW", PLANET_TRACK_ECONOMY, 5, 7, "Regress an enemy ship -1."),
    ...
    PLANET_NIBIRU => new PlanetInfo("NIBIRU", PLANET_TRACK_DIPLOMACY, 5, 7, "Enemmies must now pay 2 per follow this turn (only during your turn)."),
...
const ENERGY_PLANETS = array(
    PLANET_AUGHMOORE => new PlanetInfo("AUGHMOORE", PLANET_TRACK_DIPLOMACY, 5, 7, "Acquire culture for every ship landed in your galaxy."),
    PLANET_BIRKOMIUS => new PlanetInfo("BIRKOMIUS", PLANET_TRACK_DIPLOMACY, 1, 1, "On your turn after utilizing this colony, if you are followed then acquire 1 culture per follow."),
    PLANET_BRUMBAUGH => new PlanetInfo("BRUMBAUGH", PLANET_TRACK_DIPLOMACY, 3, 3, "Spend 2 energy to regress 2 enemy ships by -1."),
    ...
    PLANET_GLEAMZANIER => new PlanetInfo("GLEAM-ZANIER", PLANET_TRACK_DIPLOMACY, 4, 5, "Acquired 2 energy, all other players acquire 1 energy."),
    ...
    PLANET_LEANDRA => new PlanetInfo("LEANDRA", PLANET_TRACK_DIPLOMACY, 1, 1, "Advance +1 economy."),
    ...
    PLANET_MJ120210 => new PlanetInfo("MJ-120210", PLANET_TRACK_DIPLOMACY, 2, 2, "Acquire 2 energy."),
    ...
    PLANET_VICIKS156 => new PlanetInfo("VICI-KS156", PLANET_TRACK_ECONOMY, 1, 1, "Acquire 1 energy."), 
